  ...
  const branches = [
    {
      ...
      features: [
        "Free consultation",
        "Main headquarters — practising since 1965",
    ...
    },
    {
      ...
      name: "Mumbai",
      city: "Mumbai",
      address: "Sitaram Building, F-9 Block, MRA Marg, Phaltan Road, Mumbai 400001",
      phone: "+91 97662 27792",
      kitPriceInr: 200,
      isHq: false,
      popular: true,
    ...
    },
    {
      ...
      name: "Navi Mumbai",
      city: "Navi Mumbai",
      address: "Balaji Towers, B Wing - 1202, Sector 22, Nerul West, Navi Mumbai 400706",
      phone: "+91 97662 27792",
      kitPriceInr: 300,
      isHq: false,
      popular: false,
  ...
  const products = [
    {
      ...
      tagline: "The traditional one-week course",
      description:
        "Our original herbal formulation for jaundice care, prepared the same way since 1965. Includes seven daily doses, a dietary guidance chart, and instructions in Marathi, Hindi and English. Priced by centre — consultation is always free.",
      priceInr: 50,
      courseDays: 7,
      active: true,
    },
    {
      // Retired from the storefront; kept so old demo orders stay intact.
      slug: "extended-kit",
